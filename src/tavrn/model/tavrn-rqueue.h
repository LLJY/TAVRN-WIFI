...
#ifndef TAVRN_RQUEUE_H
#define TAVRN_RQUEUE_H
...
/**
 * @ingroup tavrn
 * @brief TAVRN route request queue
 *
 * Since TAVRN uses on-demand routing we queue requests while looking for route.
 */
class RequestQueue
{
  public:
